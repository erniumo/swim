...
import com.guo.gymxmjpa.service.LoosDaoImpl;
import com.guo.gymxmjpa.dao.LoosDao;
import com.guo.gymxmjpa.entity.Loos;
...
public class LoosController {
   ...
   private LoosDao loosDao;
    ...
    @RequestMapping("/jin10")
    public String jin10(){

        return "WEB-INF/jsp/loos1";
    }
