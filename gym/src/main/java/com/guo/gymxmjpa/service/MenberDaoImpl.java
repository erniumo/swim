package com.guo.gymxmjpa.service;

import com.guo.gymxmjpa.entity.Chongzhi;
import com.guo.gymxmjpa.entity.GoodInfo;
import com.guo.gymxmjpa.dao.GoodInfoDao;
import com.guo.gymxmjpa.dao.MenberDao;
import com.guo.gymxmjpa.dao.PrivateCoachInfoDao;
import com.guo.gymxmjpa.dao.chongzhiDao;
import com.guo.gymxmjpa.entity.Member;
import com.guo.gymxmjpa.entity.PrivateCoachInfo;
import com.guo.gymxmjpa.entity.*;
...
public class MenberDaoImpl {
    ...
    public Map<String,Object> userquery(Map<String,Object> map1,long id){
        //根据会员到期的日期修改到期后状态
        List<Member> memberslist= new ArrayList<>();
        memberslist.add(menberDao.findByMemberId(id));
