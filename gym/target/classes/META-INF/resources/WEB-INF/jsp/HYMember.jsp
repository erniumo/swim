    ...
    <script>
        ...
        function tianjia() {
            ...
            $.post("${pageContext.request.contextPath}/ktype/query2",{"xztype":optype},function (releset) {
                ...
                $.post("${pageContext.request.contextPath}/menber/insert",{"memberName":name,"memberPhone":phone,"memberSex":sex,"birthday":srdata,"Membertypes.typeId":optype,"nenberDate":data,"memberAge":age,"Memberxufei":rq,"username":username,"password":"123456"},function (releset) {
                    if(releset != null){
                        $("#dg").bootstrapTable('load',releset) ;
        ...
        function upd() {
            ...
            $.post("${pageContext.request.contextPath}/ktype/query2",{"xztype":optype},function (releset) {
                ...
                var qb=date2.setDate(date1.getDate() + typetian);
                var rq=date2.getFullYear() + "-" + (date2.getMonth() + 1) + "-" + date2.getDate();
                $.post("${pageContext.request.contextPath}/menber/update",{"memberId":id,"memberName":name,"memberPhone":phone,"memberSex":sex,"birthday":srdata,"membertypes.typeId":optype,"nenberDate":data,"memberAge":age,"Memberxufei":rq,"username":username,"password":password},function (releset) {
                            $("#dg").bootstrapTable('load',releset) ;
                            if(releset != null){
                                $("#dg").bootstrapTable('load',releset) ;
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group" style="display: none">
                            ...
                            <input type="text" class="form-control" id="password" disabled="disabled">
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
