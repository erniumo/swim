...
<head>
    ...
    <script>
        $(function () {
            ...
            $('#dg').bootstrapTable({
                url:'${pageContext.request.contextPath}/menber/userquery',
                method:'post',
                ...
                onDblClickRow:function(row,$element,field) {
                    ...
                    $.post("${pageContext.request.contextPath}/ktype/query",{},function (releset) {
                        ...
                        $(e).each(function () {
                            if (this.typeId == row.membertypes.typeId) {
                    ...
                    // console.log("xxxxxxx:" + row.membertypes.typeId);
                    // $('#upoptype').val(row.membertypes.typeId.toString());
        ...
        function upd() {
            ...
            $.post("${pageContext.request.contextPath}/ktype/query2",{"xztype":optype},function (releset) {
                ...
                var qb=date2.setDate(date1.getDate() + typetian);
                var rq=date2.getFullYear() + "-" + (date2.getMonth() + 1) + "-" + date2.getDate();
                $.post("${pageContext.request.contextPath}/menber/userupdate",{"memberId":id,"memberName":name,"memberPhone":phone,"memberSex":sex,"birthday":srdata,"membertypes.typeId":optype,"nenberDate":data,"memberAge":age,"Memberxufei":rq,"username":username,"password":password},function (releset) {
                            $("#dg").bootstrapTable('load',releset) ;
                            if(releset != null){
                                $("#dg").bootstrapTable('load',releset) ;
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="optype" class="control-label">卡型:</label>
                            <select class="form-control" id="upoptype" disabled="disabled">
